...
local title,title2 = '.cc | v%s | fps %s | ping %s', 'Biowin.cc | PAID'
...
do
    ...
    Library = loadstring(game:HttpGet(repo..'library_main.lua'))()
    ThemeManager = loadstring(game:HttpGet(repo..'library_theme.lua'))()
    SaveManager = loadstring(game:HttpGet(repo..'library_save.lua'))()
    _esplib = loadstring(game:HttpGet(repo..'old_esp_library.lua'))()
end
...
do
    ...
    RunService.RenderStepped:Connect(function(delta)
        if varsglobal.cursor.Enabled then
            ...
            if varsglobal.cursor.CustomPos then pos = varsglobal.cursor.Position else pos = Vector2.new(plrs.LocalPlayer:GetMouse().X, plrs.LocalPlayer:GetMouse().Y + game:GetService("GuiService"):GetGuiInset().Y)end
            ...
            wrap(function()
                while hoodlegends.moneyaura do
                    for i, v in pairs(game:GetService("Workspace"):GetChildren()) do
                        if v:FindFirstChildWhichIsA("ClickDetector") and (v.Position - plrs.LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 40 * hoodlegends.moneyauradist then
    ...
    pcall(function()
        ...
        TowerOfHell:AddButton('anticheat bypass', function()
            ...
            TowerOfHell:AddButton('godmode', function()
                local function f()
                    plrs.LocalPlayer.Character.KillScript:Destroy()
                end
